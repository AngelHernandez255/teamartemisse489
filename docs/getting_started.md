# Getting Started with TeamArtemisSE489
...
**Using conda:**
```bash
conda create -n teamartemisse489 python=3.11
conda activate teamartemisse489
```
...
```bash
python -m teamartemisse489.predict_model --model-path models/model.pkl --input data/test.csv
```
...
pytest tests/ --cov=teamartemisse489
...
├── src/
│   └── teamartemisse489/          # Importable package (src/ layout)
